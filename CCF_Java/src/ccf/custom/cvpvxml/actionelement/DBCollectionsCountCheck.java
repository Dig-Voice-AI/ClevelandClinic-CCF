...
public class DBCollectionsCountCheck extends DecisionElementBase implements ElementInterface {
	...
	public static final String RES_OUTPUT     = "CollectionCount";
	...
	throws ElementException {
		...
		try {
			...
			// Special mock value -- for testing only
			if(useMockData && empiValue.equals("13040079404"))
			{
				cr.empiResponse = "1";
			}
			else
			{
				cr = da.getEmpiCollectionsCountResponse(empiValue);				
			}
