...
public class DBPullOnBaseDocIDs extends DecisionElementBase implements ElementInterface {
	...
	public static final String RES_OUTPUT     = "GuarantorID";
	...
	throws ElementException {
		...
		try {
			...
			if(empiValue.length() >= 5)
			{
				...
				cr = da.getEmpiPullGuarantorIdForOnBaseResponse(empiValue);
			}
			else
			{
...
//			data.setSessionData("s_PayXDOCID", cr.empiResponse);
			...
			data.addToLog("Response", cr.toString());
