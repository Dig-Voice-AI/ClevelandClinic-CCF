...
public class First2OfString extends ActionElementBase implements ElementInterface {

	private static final String RES_NAME = "First2";
	...
	public String getDescription() {
		return "Returns first 2 characters of input string";
	}
