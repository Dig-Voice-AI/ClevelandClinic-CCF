...
public class DBCreditCountCheck extends DecisionElementBase implements ElementInterface {
	...
	public static final String RES_OUTPUT     = "CreditCount";
	...
	throws ElementException {
		...
		try {
			...
			if(useMockData && empiValue.equals("13039973633"))
			{
				cr.empiResponse = "1";
			}
			else
			{
				cr = da.getEmpiCreditCountResponse(empiValue);				
			}
