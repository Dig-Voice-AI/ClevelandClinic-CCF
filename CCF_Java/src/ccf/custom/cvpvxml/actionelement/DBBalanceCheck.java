...
public class DBBalanceCheck extends DecisionElementBase implements ElementInterface {
	...
	public static final String RES_OUTPUT     = "Balance";
	...
	throws ElementException {
		...
		try {
			...
			if(useMockData && empiValue.equals("13040173596"))
			{
				cr.empiResponse = "-10.00";
			}
			else
			{
				cr = da.getEmpiBalanceResponse(empiValue);				
			}
